...
const NavBar = ({ isOpen, onClose, onLogout, onEdit, isEditMode, userProfile }) => {
  return (
    <>
      {isOpen && (
        <div 
        ...
        <div className="p-4">
          ...
          <nav className="mt-6">
            <ul className="space-y-4">
              ...
              <li>
                <a href="/profile" className="block py-2 text-gray-700 hover:text-blue-600 transition-colors">
                  Profile
                </a>
              </li>
              <li>
                <a href="/settings" className="block py-2 text-gray-700 hover:text-blue-600 transition-colors">
                  Settings
                </a>
              </li>
              <li>
                <button
                  onClick={onEdit}
                  className={`w-full text-left py-2 ${isEditMode ? 'text-blue-600' : 'text-gray-700'} hover:text-blue-600 transition-colors`}
                >
